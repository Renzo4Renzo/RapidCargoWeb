                    ...
                    <div class="col-lg-12">
                        <div class="view-header">
                            ...
                            <div class="header-title">
                                <h3 class="m-b-xs">Encomiendas Esperando Salida</h3>
                            </div>
                        </div>
                        <hr>
                    </div>
                                    ...
                                    <tbody>
										<c:forEach items="${listita}" var = "list">
											<tr>
												...
												<td><c:out value="${list.sucursalOrigen.nombreAgencia}"/></td>
												<td><c:out value="${list.peso}"/></td>
												<td><c:out value="${list.fechaLlegada}"/></td>
												<td><a href="${pageContext.request.contextPath}/AsignarEncomiendasSalida?idEncomienda=${list.idEncomienda}"> Asignar </a></td>
											</tr>
										</c:forEach>
                                    </tbody>
                                </table>
